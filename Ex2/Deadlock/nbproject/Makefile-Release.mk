...
${OBJECTDIR}/main_deadlk.o: main_deadlk.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_deadlk.o main_deadlk.cpp

${OBJECTDIR}/main_nodeadlk.o: main_nodeadlk.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_nodeadlk.o main_nodeadlk.cpp
