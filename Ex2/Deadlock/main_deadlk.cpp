/*
 * Compile with:
 * g++-4.9 -std=gnu++14 -pthread main_deadlk.cpp -o Deadlock
 * 
 * Run with:
 * ./Deadlock
 * 
 * Why deadlock: see line 26 and line 52
 */
...
public:
    ...
    void Run()
    {
        ...
        auto rightForkIndex = (m_index - 1) % PHIL_COUNT;   // replaced + with -
